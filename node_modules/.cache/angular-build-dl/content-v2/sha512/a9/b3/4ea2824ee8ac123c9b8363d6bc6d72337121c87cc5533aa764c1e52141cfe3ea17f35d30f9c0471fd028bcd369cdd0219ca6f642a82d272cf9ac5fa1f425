  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    function srcAppAboutPageAboutComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var AboutComponent = /*#__PURE__*/function () {
        function AboutComponent(routingService) {
    ...
    function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, {
          declarations: [_app_component__WEBPACK_IMPORTED_MODULE_3__["AppComponent"], _login_login_component__WEBPACK_IMPORTED_MODULE_4__["LoginComponent"], _register_register_component__WEBPACK_IMPORTED_MODULE_5__["RegisterComponent"], _userhome_userhome_component__WEBPACK_IMPORTED_MODULE_6__["UserhomeComponent"], _transactions_transactions_component__WEBPACK_IMPORTED_MODULE_12__["TransactionsComponent"]],
          imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_2__["AppRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["ReactiveFormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_9__["HttpClientModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_10__["BrowserAnimationsModule"], _angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_11__["MatSnackBarModule"]]
        });
      })();
      /*@__PURE__*/
    ...
    function srcAppLoginLoginComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var LoginComponent = /*#__PURE__*/function () {
        function LoginComponent(routingService, userService, localStorage, snackBar) {
        ...
        _createClass(LoginComponent, [{
          ...
          value: function login() {
            ...
            this.userService.login(JSON.stringify(this.loginForm.value)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["tap"])(function (res) {
              localStorage.setItem('_id', res.user._id);

              _this.snackBar.open('Login Successful!', 'X', {
                duration: 4000
              });

              _this.routingService.navigate(['/user']);
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (error) {
              _this.snackBar.open('Incorrect email or password!', 'X', {
                duration: 4000
              });
      ...
      LoginComponent.ɵfac = function LoginComponent_Factory(t) {
        return new (t || LoginComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_user_service__WEBPACK_IMPORTED_MODULE_5__["UserService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_ngx_pwa_local_storage__WEBPACK_IMPORTED_MODULE_6__["LocalStorage"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_7__["MatSnackBar"]));
      };
    ...
    function srcAppRegisterRegisterComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var RegisterComponent = /*#__PURE__*/function () {
        function RegisterComponent(routingService, userService, snackBar) {
        ...
        _createClass(RegisterComponent, [{
          ...
          value: function register() {
            ...
            this.userService.register(JSON.stringify(this.registerForm.value)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["tap"])(function (res) {
              _this2.snackBar.open('Registration Successful!', 'X', {
                duration: 3000
              });

              _this2.routingService.navigate(['/login']);
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (error) {
              _this2.snackBar.open(error, 'X', {
                duration: 4000
              });
      ...
      TransactionsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        template: function TransactionsComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, "transactions working pog");
    ...
    function srcAppUserhomeUserhomeComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var UserhomeComponent = /*#__PURE__*/function () {
        function UserhomeComponent(userService, routerService, SnackBar) {
        ...
        _createClass(UserhomeComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.userService.user().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["tap"])(function (res) {
              _this3.username = res.username;
              _this3.balance = res.balance;
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (error) {
              _this3.SnackBar.open('Unauthorised access! Please login', 'X', {
                duration: 5000
              });

              _this3.routerService.navigate(['/login']);
          ...
          value: function logout() {
            ...
            this.userService.logout().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["tap"])(function (res) {
              _this4.routerService.navigate(['/login']);
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (error) {
              _this4.SnackBar.open(error, 'X', {
                duration: 5000
              });
          ...
          value: function updateBalance() {
            ...
            this.userService.UpdateBalance({
              ...
              _this5.routerService.navigate(['/user']);
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (error) {
              _this5.SnackBar.open('Invalid value!', 'X', {
                duration: 5000
              });
          ...
          value: function withdrawBalance() {
            ...
            this.userService.UpdateBalance({
              ...
              _this6.routerService.navigate(['/user']);
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (error) {
              _this6.SnackBar.open('Invalid value!', 'X', {
                duration: 5000
              });
      ...
      UserhomeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 24,
        vars: 3,
        consts: [[1, "row", 2, "margin-top", "40px", "background-color", "#00CED1", "border-radius", "15px", "-webkit-box-shadow", "0px 0px 5px 2px rgba(0,0,0,0.2)", "-moz-box-shadow", "0px 0px 5px 2px rgba(0,0,0,0.2)", "box-shadow", "0px 0px 5px 2px rgba(0,0,0,0.2)"], [1, "col-sm-12"], [1, "jumbotron"], [1, "display-4"], [1, "lead"], [1, "my-4"], [1, "lower-section"], [1, "form-group"], ["for", "deposit-number-input", 1, "col-0", "col-form-label"], [1, "col-13"], ["type", "number", "value", "", "id", "deposit_number_input", "placeholder", "Enter an amount to deposit or withdraw", 1, "form-control", 3, "ngModel", "ngModelChange"], ["id", "emailHelp", 1, "form-text", "text-muted"], ["role", "toolbar", "aria-label", "Toolbar with button groups", 1, "btn-toolbar"], ["role", "group", "aria-label", "First group", 1, "btn-group", "mr-4"], ["role", "button", 1, "btn", "btn-primary", "btn-lg", 3, "click"], ["role", "group", "aria-label", "second group", 1, "btn-group", "mr-3", "ml-3"], ["role", "button", 1, "btn", "btn-secondary", "btn-lg", 3, "click"], ["role", "group", "aria-label", "third group", 1, "btn-group", "ml-4"], ["role", "button", 1, "btn", "btn-danger", "btn-lg", 3, "click"]],
    ...
    function _(module, exports, __webpack_require__) {
      ...
      /*! C:\Users\caela\OneDrive\Documents\GitHub\MEAN_Stack_Banking_App_CW\frontend\src\main.ts */
      "./src/main.ts");
      /***/
    }
  }, [[0, "runtime", "vendor"]]]);
